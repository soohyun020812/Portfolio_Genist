...
>해결 방법은 관련 3개의 버튼을 새로운 <div>로 묶고, container을 flex로 세로정렬하여 3개의 버튼을 묶고 해결되었다.
![image](https://github.com/soohyun020812/Portfolio/assets/131852352/924e85df-1be3-421a-ab41-62fbd22571f8)
...
### 💭 프로젝트 회고
>개발 구현에 있어서 기획 단계의 중요도를 다시 한 번 알게 된 시간이었다.
>팀원들과 같이 진행한 프로젝트는 경험이 있어서 역할을 분담하고 같이 아이디어 하는 시간이 있었지만,
>개인 프로젝트에 있어서 처음부터 끝까지 자신이 혼자 다 해야하는 부분에 대해 첫 단추의 중요성을 알 수 있었다.
>기획을 탄탄하게 잡고 가면 해야할 방향의 흐름이 정해지지만 그렇지 않을 경우 헤맬 수 있다는 걸 느꼈다.
