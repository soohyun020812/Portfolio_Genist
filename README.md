...
### 🚩 프로젝트 목표
>**편리성 : 사용자에게 맞춤으로 서비스를 제공하여 불필요한 시간은 제외하고 최적화된 답변 제공** <br>
>**다양성 : 사용자에게 다양한 작업을 제공할 수 있고 피드백을 통해 높은 발전 가능성** <br>
>**소통성 : 사용자에게 대화를 제공함으로 자연스러운 소통을 제공** <br>
...
### 👤 사용자
>**메인화면 지니스트 시작하기 클릭** <br>
>**지니스트 인삿말을 시작으로 필요한 서비스 클릭** <br>
>**일정 추가, 조회, 삭제는 사용자의 입력대로 저장됨** <br>
>**채팅하기를 클릭할 경우 지니스트와 대화 시작** <br>
>**필요한 일정을 정리한 후 종료하기를 클릭 시 지니스트와 대화 종료** <br>
...
>**3. 사용자가 작성한 모든 일정을 저장할 수 있도록 DB 연결**
